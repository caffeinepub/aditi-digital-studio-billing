...
import { FileText, TrendingUp, CheckCircle2, Clock, PlusCircle, ArrowRight, AlertCircle } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const totalOutstanding = invoices?.reduce((sum, inv) => {
    ...
    return sum + Math.max(0, inv.total - paidAmt);
  }, 0) ?? 0;
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right hidden sm:block">
                        ...
                        <p className={`text-xs font-medium ${balance > 0 ? 'text-amber-600' : 'text-success'}`}>
