...
export class Backend implements backendInterface {
    ...
    async getAllInvoices(): Promise<Array<InvoiceDTO>> {
        if (this.processError) {
            try {
    ...
    async getInvoice(arg0: bigint): Promise<InvoiceDTO> {
        if (this.processError) {
            try {
    ...
    async markAsPaid(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async markAsUnpaid(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markAsUnpaid(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
